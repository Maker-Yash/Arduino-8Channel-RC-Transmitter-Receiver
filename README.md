...
[![Arduino CI](https://github.com/Maker-Yash/Arduino-8Channel-RC-Transmitter-Receiver/actions/workflows/arduino-compile.yml/badge.svg)]
...
| :--- | :--- | :--- | :--- |
| **CH1 Output** | `D0` (RX0) | Aileron / Steering Servo | Standard 1000–2000µs 50Hz PWM (UART RX disabled in code) |
